...
def guide_pdf(path):
    ...
    for text in [
        ...
        'Prévoir deux élèves par PC. À deux, faire alterner le clavier ; la case de travail en binôme fait apparaître un second bilan individuel.',
...
Les PDF élèves peuvent être imprimés ou consultés à l’écran. Distribuer le cours AVANT, puis l’activité, puis la trace APRÈS. Le dossier professeur/ contient les corrigés et un PDF réunissant tous les cours. Schémas originaux et illustration de cartable générée par IA ; aucune ressource extérieure n’est nécessaire.
